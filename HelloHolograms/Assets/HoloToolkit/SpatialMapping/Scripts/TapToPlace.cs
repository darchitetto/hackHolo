        ...
        void Update()
        {
            ...
            if (placing)
            {
                ...
                if (Physics.Raycast(headPosition, gazeDirection, out hitInfo,
                    30.0f, Physics.DefaultRaycastLayers)) // SpatialMappingManager.Instance.LayerMask))
                {
                ...
                else
                {
                    ...
                    var position = origin + direction * 3.0f;
                    this.transform.position = GazeManager.Instance.Position + GazeManager.Instance.Normal * .01f; // position;
